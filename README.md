...
| # | Module | Functionalities | Dependent Module(s) |
| --- | --- | --- | ---- |
| 1 | Moderation Layer <br>(Comprehensive suite of Safety, Privacy, Explainability, Fairness and Hallucination tenets) | To regulate the content of prompts and responses generated by LLMs | 
[responsible-ai-moderationmodel](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-ModerationModel) ,<br>[responsible-ai-admin](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-admin)|
| 2 | Security | ()
[responsible-ai-model-detail](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-model-detail) ,<br>[responsible-ai-reporting-tool](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-reporting-tool)|
| 3 | Red Teaming |()
[responsible-ai-red-teaming](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-red-teaming)| 
| 4 | Explainability  Get Explainability to LLM responses, <br>Global and local explainability for Regression, Classification and Timeseries Models | 
[responsible-ai-model-detail](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-model-detail),<br>
...
| 5 | LLM Explain |()
[responsible-ai-moderationlayer](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-moderation-layer)|
| 6 | Image Explainability |()
[responsible-ai-fairness](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-fairness),<br>
[reponsible-ai-llm](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-llm)|
| 7 | RAI LLM | ()
[reponsible-ai-llm](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-llm)|
| 8 | Privacy | Detect and anonymize or encrypt or hilight PII information in prompts for LLMs or in its responses | [responsible-ai-admin](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-admin)|
| 9 | Safety | Detects and anonymize toxic and profane text associated with LLMs | 
[reponsible-ai-llm](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-llm)|
| 10 | Fairness & Bias | Check Fairness and detect Biases associated with LLM prompts and responses and also for traditional ML models | 
[responsible-ai-model-details](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-model-detail),<br>
[responsible-ai-reporting-tool](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-reporting-tool),<br>
[responsible-ai-file-storage](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-file-storage)|
| 11 | Hallucination | Detect and quantify Hallucination in LLM responses under RAG scenarios | [responsible-ai-hallucination](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-hallucination) |
| 12 | Work Bench | ()
[responsible-ai-moderation-layer](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/master/responsible-ai-moderation-layer)|
